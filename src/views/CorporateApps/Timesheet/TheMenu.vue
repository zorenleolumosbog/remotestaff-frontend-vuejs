        ...
        <div class="accordion-container ms-4">
                        ...
                        <div class="ac ps-2">
                            ...
                            <div class="ac-panel ms-1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <router-link class="nav-link sub-menu nav-menu-font" to="screen-capture-interval?init=0">Screen Capture Interval</router-link>
                                    </li>
                                    <li class="nav-item">
                                        <router-link class="nav-link sub-menu nav-menu-font" to="activity-notes-interval?init=0">Activity Notes Interval</router-link>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="ac">
                ...
                <div class="ac-panel">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <router-link class="nav-link sub-menu nav-menu-font" to="time-sheet-adjustment?init=1">Timesheet</router-link>
                        </li>
                    </ul>
                </div>
            </div>
