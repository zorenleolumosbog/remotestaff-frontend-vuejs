    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row mt-3 mb-auto">
                <div class="col-md-12">
                    <!-- <MaterialButton @click="details.showDelete = !details.showDelete" :disabled="details.selectedRecords.length <= 0" variant ="light" size="sm" class="btn-icon command-btn mx-1 left-floater">
                    ...
                    <div class="row mt-4">
                        <!-- <div class="col-xl-12 shh"> -->
                            <!--Jobseeker Dropdown-->
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <small class="label">Staff Name</small>
                            ...
                            <!--Client Dropdown-->
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <small class="label">Registrant Type</small>
                            ...
                            <!--Convert Button-->
                            <div class="col-lg-2 col-md-6 col-sm-12">
                                <MaterialButton @click="getRecords" :disabled="!details.selectedJobseeker || !details.selectedClient" variant ="light" size="sm" style="margin-top: 25px !important;" class="btn-icon command-btn left-floater w-100">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <i class="icons fa fa-search fa-lg mx-1" style="font-size: 15px;"></i>
                                        Search
                                    </div>
                                </MaterialButton>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-12 col-sm-12">
                                ...
                                <MaterialButton @click="getRecords" :disabled="!details.selectedJobseeker || !details.selectedClient" variant ="light" size="sm" style="margin-top: 25px !important;" class="btn-icon command-btn left-floater w-100">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <i class="icons fa fa-file-export fa-lg mx-1" style="font-size: 15px;"></i>
                                        Export
                                    </div>
                                </MaterialButton>
                            </div>
                        ...
                        <div class="col-xl-12 mb-4">
                            <MaterialInput v-model="details.search" @keyup="getRecords" class="d-flex right-floater mx-1 size border" icon="search mx-2" placeholder="Search User" size="sm" style="margin-top: 28px !important;" />
                        </div> -->
                    </div>
                </div>
                <!-- <div class="col-md-3">
