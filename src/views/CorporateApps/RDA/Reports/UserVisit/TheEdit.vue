        ...
        <teleport to="body">
            ...
            <template #body>
                    <div class="form-group mb-3">
                        <label for="description" class="form-label">Registrant Type</label>
    ...
    export default {
        ...
        methods: {
            ...
            getRecord() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + '/admin/registrant-type/' + self.selectedId,
            ...
            update() {
                ...
                axios({
                    method: 'put',
                    url: api.DEV_API_URL + `/admin/update-registrant-type/${self.selectedId}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
                    data: {
