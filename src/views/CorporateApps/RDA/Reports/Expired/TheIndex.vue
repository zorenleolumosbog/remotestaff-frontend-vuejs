    ...
    export default {
        ...
        methods: {
            ...
            getRecords(registrantTypeId) {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/registrant-report/expired/${self.details.selectedRegistrantTypeId}?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
