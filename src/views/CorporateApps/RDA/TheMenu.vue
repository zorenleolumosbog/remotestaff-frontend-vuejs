<template>
    <nav>
        ...
        <div class="accordion-container ms-4">
            <div class="ac">
                ...
                <div class="ac-panel">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <router-link class="nav-link sub-menu nav-menu-font" to="reports-verified?init=0">Verified</router-link>
                        </li>
                        <li class="nav-item my-n2">
                            <router-link class="nav-link sub-menu nav-menu-font" to="reports-unverified?init=0">Unverified</router-link>
                        </li>
                        <li class="nav-item">
                            <router-link class="nav-link sub-menu nav-menu-font" to="reports-expired?init=0">Expired</router-link>
                        </li>
                        <li class="nav-item my-n2">
                            <router-link class="nav-link sub-menu nav-menu-font" to="audit-trail?init=0">Audit Trail Logs</router-link>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="ac">
                <h2 class="ac-header">
                    <button type="button" class="ac-trigger">Dashboard</button>
                </h2>
                <div class="ac-panel">
            ...
            <div class="ac">
                <h2 class="ac-header">
                    <button type="button" class="ac-trigger">Analytics</button>
                </h2>
                <div class="ac-panel">
