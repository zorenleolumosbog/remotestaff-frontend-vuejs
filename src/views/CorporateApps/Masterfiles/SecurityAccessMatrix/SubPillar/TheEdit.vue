...
export default {
  name: "TheAddEdit",
  props: ["show", "selectedData", "selectedIndex", "pillarOptions"],
  components: {
    StandardModal,
    MaterialButton,
    axios
  ...
  data() {
    return {
      ...
      fieldErrors: {
        description: {
          error: false,
          message: "Sub Pillar Name is required."
        },
        link_pillar_id: {
          error: false,
  ...
  methods: {
    ...
    formValidation() {
      ...
      this.fieldErrors.link_pillar_id.error = !formData.link_pillar_id
        ? true
        : false;
    },
    ...
    setDefaultValue() {
      this.formData = {
        ...
        link_pillar_id: this.selectedData["pillar_id"]
      };
    }
  },
  mounted() {
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <select
                ...
                v-model="formData.link_pillar_id"
              >
                <option
              ...
              <span v-if="fieldErrors.link_pillar_id.error" class="error_msg"
                >&nbsp;{{ fieldErrors.link_pillar_id.message }}</span
              >
            </div>
          </div>
          <div class="col-12">
            <div class="form-group">
              <label for="clinet_name" class="labels my-0"
                >Sub Pillar Name <span class="required-field">*</span></label
              >
              <input
                type="text"
