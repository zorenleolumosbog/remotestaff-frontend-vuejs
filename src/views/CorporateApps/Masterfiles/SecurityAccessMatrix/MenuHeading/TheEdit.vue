...
export default {
  name: "TheAddEdit",
  props: ["show", "selectedData", "selectedIndex", "options"],
  components: {
    StandardModal,
    MaterialButton,
    axios
  ...
  methods: {
    ...
    formValidation() {
      ...
      this.fieldErrors.link_sub_pillar_module_id.error = !formData.link_sub_pillar_module_id
        ? true
        : false;
    },
    ...
    setDefaultValue() {
      this.formData = {
        ...
        link_sub_pillar_module_id: this.selectedData["sub_pillar_id"]
      };
    }
  },
  mounted() {
          ...
          <div class="col-12">
            <div class="form-group">
              <label for="clinet_name" class="labels my-0"
                >Module <span class="required-field">*</span></label
              >
              <select
                class="form-control field input-date border form-select"
                v-model="formData.link_sub_pillar_module_id"
              >
                <optgroup
              ...
              <span
                v-if="fieldErrors.link_sub_pillar_module_id.error"
                class="error_msg"
                >&nbsp;{{ fieldErrors.link_sub_pillar_module_id.message }}</span
              >
            </div>
          </div>
          <div class="col-12">
            <div class="form-group">
              <label for="clinet_name" class="labels my-0"
                >Menu Heading <span class="required-field">*</span></label
              >
              <input
                type="text"
