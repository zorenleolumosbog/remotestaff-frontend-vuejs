        ...
        <div class="col-md-12">
            <div class="row mt-3 mb-3">
                ...
                <div class="col-md-8 my-2">
                    ...
                    <MaterialInput v-model="details.search" @keyup="getRecords" class="d-flex right-floater mx-1 size border" icon="search mx-2" placeholder="Search Account Classification" size="sm"/>
                </div>
            </div>
            <div class="row">
                            ...
                            <table id="table" class="table table-hover table-striped table-bordered">
                                <thead class="bg-header">
                                    <tr>
                                        ...
                                        <th scope="col">Account Classification</th>
                                    </tr>
                                </thead>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                details: {
                    title: 'Manage Account Classification',
                    addTitle: 'Add Account Classification',
                    editTitle: 'Edit Account Classification',
                    showAdd: false,
                    showEdit: false,
        ...
        methods: {
            ...
            getRecords() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/account-classification?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
