    ...
    <template v-if="!details.showLoader && !details.alertBox.success">
        <teleport to="body">
            ...
            :isScrollable=true>
                ...
                <template #footer>
                    <material-button @click="remove" size="sm" variant="contained" color="success" class="mb-0 me-2">
                        Yes
                    </material-button>
                    <material-button @click="removeAlertBox" size="sm" variant="contained" color="dark" class="mb-0">
                        Cancel
                    </material-button>
                </template>
            </standard-modal>
        ...
        methods: {
            ...
            remove() {
                ...
                this.selectedIds.forEach((selectedId) => {
                    axios({
                        method: 'delete',
                        url: api.DEV_API_URL + `/admin/delete-onboard-registration-expiry/${selectedId}`,
