        ...
        <div class="col-md-12">
            <div class="row mt-2 mb-n2">
                ...
                <div class="col-md-8 my-2 py-2">
                    ...
                    <MaterialInput v-model="details.search" @keyup="getRecords" class="d-flex right-floater mx-1 size border" icon="search mx-2" placeholder="Search Country" size="sm"/>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <tr :class="{'active-row': details.selectedRecords.includes(datum.id) }" v-for="datum in details.records.data.data" :key="datum.id" @click="setSeletedRecords(datum.id)">
                                            ...
                                            <td>
                                                <div class="form-check form-switch d-inline-block">
                                                    <input :checked="datum.with_region" type="checkbox" class="form-check-input" onclick="return false;">
                                                </div>
                                            </td>
                                        </tr>
    ...
    export default {
        ...
        methods: {
            ...
            getRecords() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/country?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
