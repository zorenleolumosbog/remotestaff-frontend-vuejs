        ...
        <div class="col-md-12">
            <div class="row mt-2 mb-n2">
                ...
                <div class="col-md-8 my-2 py-2">
                    ...
                    <MaterialInput v-model="details.search" @keyup="getRecords" class="d-flex right-floater mx-1 size border" icon="search mx-2" placeholder="Search Region" size="sm"/>
                </div>
            </div>
            <div class="row">
    ...
    export default {
        ...
        methods: {
            ...
            getRecords() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/region?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
