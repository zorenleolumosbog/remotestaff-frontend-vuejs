    ...
    export default {
        ...
        methods: {
            ...
            getRecord() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/state/${self.selectedId}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
                })
                .then(function (response) {
                    ...
                    if(response.data.data.region) {
                        self.details.regionId = response.data.data.region.id;
                        self.details.countryId = response.data.data.region.country.id;
                    } else {
                        self.details.countryId = response.data.data.country.id;
                        self.geographies.withRegion = response.data.data.country.with_region;
                    }
            ...
            update() {
                ...
                axios({
                    method: 'put',
                    url: api.DEV_API_URL + '/admin/update-state/' + self.selectedId,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
                    data: {
