        ...
        <div class="col-md-12">
            <div class="row mt-3 mb-3">
                ...
                <div class="col-md-8 my-2">
                    ...
                    <MaterialInput v-model="details.search" @keyup="getRecords" class="d-flex right-floater mx-1 size border" icon="search mx-2" placeholder="Search Degree Level" size="sm"/>
                </div>
            </div>
            <div class="row">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                details: {
                    title: 'Manage Degree Level',
                    addTitle: 'Add Degree Level',
                    editTitle: 'Edit Degree Level',
                    showAdd: false,
                    showEdit: false,
        ...
        methods: {
            ...
            getRecords() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/degree-level?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
