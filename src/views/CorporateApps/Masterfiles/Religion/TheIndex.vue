        ...
        <div class="col-md-12">
            <div class="row mt-3 mb-3">
                ...
                <div class="col-md-8 my-2">
                    ...
                    <MaterialInput v-model="details.search" @keyup="getRecords" class="d-flex right-floater mx-1 size border" icon="search mx-2" placeholder="Search Religion" size="sm"/>
                </div>
            </div>
            <div class="row">
    ...
    export default {
        ...
        data() {
            return {
                details: {
                    ...
                    addTitle: 'Add Religion',
                    editTitle: 'Edit Religion',
                    showAdd: false,
                    showEdit: false,
        ...
        methods: {
            ...
            getRecords() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/religion?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
