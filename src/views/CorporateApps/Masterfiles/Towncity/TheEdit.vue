    ...
    export default {
        ...
        methods: {
            ...
            getRecord() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/towncity/${self.selectedId}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
                })
                .then(function (response) {
                    self.details.description = response.data.data.description;
                    self.details.zipCode = response.data.data.zip_code;
                    ...
                    if(response.data.data.state.region) {
                        ...
                        self.geographies.withRegion = response.data.data.state.country.with_region;
                    }
            ...
            update() {
                ...
                axios({
                    method: 'put',
                    url: api.DEV_API_URL + '/admin/update-towncity/' + self.selectedId,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
                    data: {
