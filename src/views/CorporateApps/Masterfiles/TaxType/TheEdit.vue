            ...
            :isScrollable=true>
                <template #body>
                    <div class="form-group mb-3">
                        <label for="short_desc" class="form-label">Tax Type Code</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="long_desc" class="form-label">Tax Type Description</label>
    ...
    export default {
        ...
        methods: {
            ...
            getRecord() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + '/admin/tax-type/' + self.selectedId,
            ...
            update() {
                ...
                axios({
                    method: 'put',
                    url: api.DEV_API_URL + `/admin/update-tax-type/${self.selectedId}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
                    data: {
