    ...
    export default {
        ...
        methods: {
            ...
            getRecord() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/admin/cancellation-reason-type/${self.selectedId}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
                })
                .then(function (response) {
                    self.details.contractStatusId = {
                        id: response.data.data.link_contract_status_id,
                        description: response.data.data.contract_status.description
                    }
            ...
            update() {
                ...
                axios({
                    method: 'put',
                    url: api.DEV_API_URL + '/admin/update-cancellation-reason-type/' + self.selectedId,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
                    data: {
