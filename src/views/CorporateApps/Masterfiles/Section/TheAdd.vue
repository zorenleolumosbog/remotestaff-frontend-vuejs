    ...
    <template v-if="!confirmations.showLoader && !confirmations.alertBox.success">
        <teleport to="body">
            ...
            :isScrollable=true>
                <template #body>
                    <div class="row">
                        <div class="form-group section-of-department1 mb-3">
    ...
    export default {
        ...
        methods: {
            ...
            store() {
                ...
                axios({
                    method: 'post',
                    url: api.DEV_API_URL + '/admin/store-department-section',
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
                    data: {
                        department_id: self.details.departmentId,
...
<style>
.section-of-department1 .vs__dropdown-menu{
