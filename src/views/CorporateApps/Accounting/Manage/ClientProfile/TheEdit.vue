<script>
    ...
    export default {
        name: "TheAddEdit",
        props: ['show', 'countries', 'selectedOptions', 'selectedData', 'selectedIndex','currencyOption'],
        components: {
            StandardModal,
            MaterialButton,
            axios
        ...
        methods : {
            ...
            getRegionState ( id ) {
                ...
                axios.get(this.API_URL+'/admin/country/' + id,{
                    ...
                    if ( response.data.success ) {
                        ...
                        this.selectOptions.regions = data['regions'];
                        this.selectOptions.states = data['states'];
            ...
            getStates ( id ) {
                ...
                for ( const x in this.selectOptions['regions'] ) {
                    if (this.selectOptions['regions'][x]['id'] == parseInt(id)) {
                        this.selectOptions['states'] = this.selectOptions['regions'][x]['states'];
                        break;
                    }
            ...
            getTownCities ( id ) {
                ...
                axios.get(this.API_URL+'/admin/state/' + id,{
                    ...
                    if ( response.data.success ) {
                        ...
                        this.selectOptions['townCities'] = data['towncities']
            ...
            setDefaultValue () {
                ...
                this.formData = {
                    ...
                    client_name : this.selectedData['client_name'],
                    client_poc : this.selectedData['client_poc'],
                    client_poc_position : this.selectedData['client_poc_position'],
                    client_addr_line1 : this.selectedData['client_addr_line1'],
                    client_addr_line2 : this.selectedData['client_addr_line2'],
                    client_country : this.selectedData['client_country'],
                    client_region : this.selectedData['client_region'],
                    client_state : this.selectedData['client_state'],
                    client_towncity : this.selectedData['client_towncity'],
                    client_email : this.selectedData['client_email'],
                    client_phone : this.selectedData['client_phone'],
                    client_ABN : this.selectedData['client_ABN'],
                    client_currency : this.selectedData['client_currency']
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select id="country" class="form-select form-select-md" v-model="formData.client_country" 
                            @change="getRegionState(formData.client_country)">
                            <option value=""></option>
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select id="country" class="form-select form-select-md" v-model="formData.client_region"
                            :disabled="checkCount(selectOptions.regions)"
                            @change="getStates( formData.client_region )">
                            <option value=""></option>
                            <option v-for="(v, k) in selectOptions.regions" :value="v.id">{{v.description}}</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select id="country" class="form-select form-select-md" v-model="formData.client_state"
                            :disabled="checkCount(selectOptions.states)"
                            @change="getTownCities( formData.client_state )">
                            <option value=""></option>
                            <option v-for="(v, k) in selectOptions.states" :value="v.id">{{v.description}}</option>
                        </select>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select id="country" class="form-select form-select-md" v-model="formData.client_towncity"
                            :disabled="checkCount(selectOptions.townCities)">
                            <option value=""></option>
                            <option v-for="(v, k) in selectOptions.townCities" :value="v.id">{{v.description}}</option>
                        </select>
                    </div>
                </div>
            </div>
