                ...
                <div class="row mb-2">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <select id="client" class="form-select form-select-md" v-model="formData.client" @click="getClients">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <select id="subcon" class="form-select form-select-md" v-model="formData.subcon" @click="getSubcons">
