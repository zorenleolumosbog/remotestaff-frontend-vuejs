<script>
    ...
    export default {
        name: "TheAddEdit",
        props: ['show', 'clientsOption', 'selectedData', 'selectedIndex', 'subcontractorsOption'],
        components: {
            StandardModal,
            MaterialButton,
            axios,
            ...
            return {
                ...
                fieldErrors : {
                    ...
                    link_client_subcon_pers: {
                        error: false,
                        message: "Remote Contractor is required.",
                    },
                    basic_monthly_rate: {
                        error: false,
        ...
        methods : {
            ...
            handleSubmit () {
                ...
                if(!this.checkTrue(hasError)){
                    ...
                    this.formData['basic_monthly_rate'] = parseFloat(this.formData['basic_monthly_rate']).toFixed(2);
                    ...
                    this.$emit( 'editContractRate', this.formData )
                }
            ...
            setDefaultValue () {
                ...
                this.selectedClient = this.selectedData['client_id'];
                this.selectedSubcon = this.selectedData['link_client_subcon_pers'];

                this.formData = {
                    id : this.selectedData['id'],
                    basic_monthly_rate : this.selectedData['basic_monthly_rate'],
                    basic_weekly_rate : this.selectedData['basic_weekly_rate'],
                    basic_daily_rate : this.selectedData['basic_daily_rate'],
                    basic_hourly_rate : this.selectedData['basic_hourly_rate'],
                    effective_date_from : this.selectedData['effective_date_from'],
                    effective_date_to : this.selectedData['effective_date_to'],
                    is_active : 1,
                }
            }
        },
            ...
            <div class="row mb-2">
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        label="name"
                        valueProp="id"
                        class="multiselect-contract-rate"
                        />
