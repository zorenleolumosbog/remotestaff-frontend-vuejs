    ...
    export default {
        ...
        data() {
            return {
                ...
                fieldErrors : {
                    invoiceId : {
                        error: false,
                        message: "Sub Invoice ID is required.",
                    },
                    voidReason : {
                        error: false,
        ...
        methods: {
            ...
            getInvoice () {
                ...
                axios.get(this.API_URL+'/accounting/voidable-client-invoice-header-item-detail/'+ this.details.id,{
                    headers:{
                    ...
                    if ( response.data.success ) {
                        this.details.record = response.data.data;
                        ...
                        this.fieldErrors.invoiceId = {
                            error: true,
                            message: "Sub Invoice ID is not found.",
                        }
                    }
            ...
            voidNow () {
                ...
                axios.put(this.API_URL+'/accounting/void-client-invoice-header-item-detail/' + this.details.id,
                    { 
                        is_void : 1,
                ...
                <div class="row mb-2 m-auto">
                    <div class="col-12 col-sm-5 col-md-5 ">
                        <div class="form-group mb-2">
                            <label for="invoice_id" class="labels my-0">Sub Invoice ID <span class="required-field">*</span></label>
                    ...
                    <div class="row mb-2">
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <span class="p-3">{{ details.record.invoice_header.client.client_poc }}</span>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label for="client_poc" class="labels my-0">Invoice Date</label><br />
                                <span class="p-3">{{ new Date(details.record.datecreated).toLocaleDateString() }}</span>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label for="client_poc" class="labels my-0">Invoice Item Type</label><br />
                                <span class="p-3">{{ details.record.invoice_item_type.description }} <span v-if="details.record.invoice_item_type.is_percentage">({{ details.record.invoice_item_type.percentage }})%</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label for="clinet_name" class="labels my-0">Hourly Rate</label><br />
                                <span class="p-3">{{ details.record.hourly_rate }}</span>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label for="clinet_name" class="labels my-0">Total Hours</label><br />
                                <span class="p-3">{{ details.record.total_hours }}</span>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label for="clinet_name" class="labels my-0">Amount Addon</label><br />
                                <span class="p-3">{{ details.record.amount_add_on }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
