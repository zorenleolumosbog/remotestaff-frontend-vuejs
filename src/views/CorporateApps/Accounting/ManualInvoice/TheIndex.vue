    ...
    <!-- <StandardLayout>
        ...
        <template #main> -->
            <div class="container-fluid py-1">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class = "col-md-12 row filters" style = "padding-right: 0">
                            <div class="col-sm-6 row">
                                <div class = "col-md-5 date-label">Invoice Date:</div>
                                <div class = "col-md-7">
                                    <div class="input-group-date" id="datepicker1">
                                        <input type="date" 
                                            class="form-control field input-date" 
                                            id="date"
                                            v-model="details.invoiceDate"
                            ...
                            <div class="col-sm-6 row">
                                <div class = "col-md-5 date-label">Due Date:</div>
                                <div class = "col-md-7">
                                    <div class="input-group-date" id="datepicker1">
                                        <input type="date" 
                                            class="form-control field input-date" 
                    ...
                    <div class="row">
                        <div class = "col-md-12 row filters" style = "padding-right: 0">
                            <div class="col-sm-6 row">
                                <div class = "col-md-5 date-label">Period From:</div>
                                <div class = "col-md-7">
                                    <div class="input-group-date" id="datepicker1">
                                        <input type="date" 
                                            class="form-control field input-date" 
                                            id="date"
                                            v-model="details.invoicePeriodFrom"
                                            :enableTimePicker="false" 
                                            style="font-size: 12pt; margin-top: 2px !important;"
                                            />
                                        <span class="input-group-append">
                            ...
                            <div class="col-sm-6 row">
                                <div class = "col-md-5 date-label">Period To:</div>
                                <div class = "col-md-7">
                                    <div class="input-group-date" id="datepicker1">
                                        <input type="date" 
                                            class="form-control field input-date" 
                                            id="date"
                                            v-model="details.invoicePeriodTo"
                                            :enableTimePicker="false" 
                                            style="font-size: 12pt; margin-top: 2px !important;"
                                            />
                                        <span class="input-group-append">
                    ...
                    <div class="row mb-2" style = "margin-top: 10px" v-if="!details.hasHeader">
                        <div class="col-xl-12">
                            <MaterialButton @click="saveInvoiceHeader" size="md" class="btn-icon yes-btn float-start">
                    ...
                    <div class="row mb-2" style = "margin-top: 20px" v-if="details.hasHeader">
                        <div class="col-xl-12">
                            ...
                            <MaterialButton @click="details.showAdd = !details.showAdd" size="md" class="btn-icon mx-1 yes-btn float-end">
                                <div class="buttons d-flex align-items-center">
                                    Add Item
                                </div>
                            </MaterialButton>
                    ...
                    <div class="row" id = "details_table" style = "display: none">
            ...
            <the-add 
                ...
                :selectedInvoiceId="details.selectedInvoice"
            ...
            <teleport to="body">
                ...
                <StandardModal 
                    v-if="details.showSaveInvoiceSuccess"
                    :show="details.showSaveInvoiceSuccess"
                    @close="details.showSaveInvoiceSuccess=!details.showSaveInvoiceSuccess"
                    :hasClose=true
                    :hasHeader=false
                    :hasFooter=false
                    title="Dialog"
                    ...
                    <template #body>
                        <h5 class = "alert-message">Invoice successfully saved.</h5><br>
                    </template>

                </StandardModal>

                <StandardModal 
                    v-if="details.showSaveInvoiceLoader"
                    :show="details.showSaveInvoiceLoader"
                    @close="details.showSaveInvoiceLoader=!details.showSaveInvoiceLoader"
                    :hasClose=false
                    :hasHeader=false
                    :hasFooter=false
                    title="Dialog"
    ...
    export default {
        ...
        watch: {
            'details.selectedClient'(newVal) {
                ...
                this.details.invoiceDetails.success = false;
            }
        },
        methods: {
            ...mapActions([
            ...
            getClients() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + '/accounting/client',
            ...
            saveInvoiceHeader() {
                let self = this;
                self.details.showSaveInvoiceLoader = true;
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/accounting/save-invoice-header?invoice_date=${self.details.invoiceDate}&due_date=${self.details.dueDate}&client=${self.details.selectedClient.id}&inv_period_from=${self.details.invoicePeriodFrom}&inv_period_to=${self.details.invoicePeriodTo}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
                })
                .then(function (response) {
                    console.log(response);
                    document.getElementById("details_table").style.display = 'block';
                    self.details.selectedInvoice = response.data.invoice_id;
                    self.details.hasHeader = true;
                    self.details.showSaveInvoiceLoader = false;
                    self.details.showSaveInvoiceSuccess = true;
                })
            },
            getClientInvoiceDetails() {
                ...
                axios({
                    method: 'get',
                    url: api.DEV_API_URL + `/accounting/prepopulated-client-invoice-header-detail/${self.details.selectedInvoice}?page=${self.details.pagination.current}&limit=${self.details.pagination.limit}&search=${self.details.search}`,
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
                })
                .then(function (response) {
                    console.log(response);
