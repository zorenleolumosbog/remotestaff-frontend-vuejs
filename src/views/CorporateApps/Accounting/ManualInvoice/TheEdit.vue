            ...
            <template #body>
                    <div class="row">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <template v-if="validations.errors.hours_rendered">
                                <span v-for="(error, index) in validations.errors.hours_rendered" :key="index" class="error-font">{{ error }}</span>
                            </template>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <template v-if="validations.errors.rate_per_hour">
                                <span v-for="(error, index) in validations.errors.rate_per_hour" :key="index" class="error-font">{{ error }}</span>
                            </template>
                        </div>
                        <div class="form-group mb-3">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getBillableAmount() {
                this.details.billableAmount = this.details.hoursRendered * this.details.hourlyRate;
            },
            getRecord() {
