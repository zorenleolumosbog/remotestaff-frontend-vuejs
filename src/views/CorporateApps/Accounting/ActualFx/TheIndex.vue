    ...
    <div class="container-fluid"> <!--removed div-bordered-->
        <div class="col-md-12">
            <div class="row mt-3 mb-n3">
                <div class="col-md-12 py-3 my-2 size">
                    <!-- <h3 class="menu-title">{{ details.title }}</h3> -->
                    <small class="menu-title">Select Year:</small>
                        <v-app>
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-bordered table-striped">
                                <thead class="bg-header">
                                    <tr>
                                        <th scope="col" class="ps-3">Currency</th>
                                        <th scope="col">Jan</th>
                                        <th scope="col">Feb</th>
                                        <th scope="col">Mar</th>
                                        <th scope="col">Apr</th>
                                ...
                                <tbody v-if="!details.showLoader">
                                    <template v-if="details.records.success">
                                        ...
                                        <tr data-sort-method='none' height="40" v-for="tr in 13 - parseInt(details.records.data.data.length)" :key="tr">
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
