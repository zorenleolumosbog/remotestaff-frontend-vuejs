<script setup>
    ...
    import HorizontalTeamCardMain from "./../../examples/cards/teamCards/HorizontalTeamCardMain.vue";
    ...
    import JobseekerLogo from "@/assets/img/jobseeker-ico.png";
    import BusinessLogo from "@/assets/img/bizdev-ico.png";
    import ClientLogo from "@/assets/img/client-manager-ico.png";
    import StaffLogo from "@/assets/img/contracted-staff-ico.png";
    import AdminLogo from "@/assets/img/in-house-adm-ico.png";
    import PartnerLogo from "@/assets/img/referal-partner-ico.png";
      ...
      <div class="container">
        <div class="row link-margin justify-content-center">
            <div class="col-lg-4"> <!--col-lg-4 changed-->
                ...
                <a @click="$router.push('/login/jobseeker')" class="link link-padding" 
                    variant="gradient"
                    color="success">
                    <HorizontalTeamCardMain
                        :image=JobseekerLogo
                        :profile="{ name: 'Jobseeker', link: '' }"
          ...
          <!-- <div class="col-lg-4">
            <div class="row padding-link" id="padding-link">
                ...
                <a v-on:click="toggleModal('bdModalShow')" class="link link-padding"
                    variant="gradient"
                    color="success"
                >
                    <HorizontalTeamCard
                        :image=BusinessLogo
                        :profile="{ name: 'Business Developer', link: '' }"
                        :position="{ label: '', color: '' }"
                        description=""
                    />
                </a>
          ...
          <div class="col-lg-4">
            <div class="row padding-link" id="padding-link">
                ...
                <a  @click="$router.push('/login/client')" class="link link-padding"
                    variant="gradient"
                    color="success"
                >
                    <HorizontalTeamCardMain
                        :image=ClientLogo
                        :profile="{ name: 'Client', link: '' }"
                        :position="{ label: '', color: '' }"
                        description=""
                    />
                </a>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                <div class="row padding-link" id="padding-link">
                    <a  @click="$router.push('/login/remote-contractor')" class="link link-padding"
                    variant="gradient"
                    color="success"
                    >
                    <HorizontalTeamCardMain
                        :image=StaffLogo
                        :profile="{ name: 'Remote Contractor', link: '' }"
                        :position="{ label: '', color: '' }"
                        description="(formerly known as Subcontractor)"
                    />
                    </a>
                </div>
            </div>
            <!-- <div class="col-lg-4 ">
                <div class="row padding-link" id="padding-link">
                <a v-on:click="toggleModal('rpModalShow')" class="link link-padding"
                    variant="gradient"
                    color="success"
                >
                    <HorizontalTeamCard
                        :image=PartnerLogo
                        :profile="{ name: 'Referral Partner', link: '' }"
                        :position="{ label: '', color: '' }"
                        description=""
                    />
                </a>
            ...
            <div class="col-lg-4">
                <div class="row padding-link" id="padding-link">
                <a v-on:click="$router.push('/login/admin')" class="link link-padding"
                    variant="gradient"
                    color="success"
                >
                    <HorizontalTeamCardMain
                        :image=AdminLogo
                        :profile="{ name: 'Corporate Apps', link: '' }"
                        :position="{ label: '', color: '' }"
                        description=""
                    />
                </a>
    ...
    <Teleport to="body">
        ...
        <!-- <template #body>
            ...
            <template #body>
                ...
                <button @click="modals.bdModalShow = false" class="btn btn-success btn-sm my-0" type="button" variant="contained">Ok</button>
                </div>
            </template>
    ...
    <Teleport to="body">
        ...
        <!-- <template #body>
            ...
            <template #body>
                ...
                <div class="d-grid gap-2 col-4 mx-auto bottom-gap">
                <button @click="modals.cmModalShow = false" class="btn btn-success btn-sm my-0" type="button" variant="contained">Ok</button>
                </div>
            </template>
    ...
    <Teleport to="body">
        ...
        <!-- <template #body>
            ...
            <template #body>
                ...
                <div class="d-grid gap-2 col-4 mx-auto bottom-gap">
                <button @click="modals.csModalShow = false" class="btn btn-success btn-sm my-0" type="button" variant="contained">Ok</button>
                </div>
            </template>
    ...
    <Teleport to="body">
        ...
        <!-- <template #body>
            ...
            <template #body>
                ...
                <div class="d-grid gap-2 col-4 mx-auto bottom-gap">
                <button @click="modals.rpModalShow = false" class="btn btn-success btn-sm my-0" type="button" variant="contained">Ok</button>
                </div>
            </template>
